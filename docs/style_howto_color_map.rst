...
.. image:: images/colour-map-simple-flags.webp
    :width: 600

`View full size:
<images/colour-map-simple-flags.webp>`__
...
.. image::  images/colour-map-better-flags.webp
    :width: 600

`View full size:
<images/colour-map-better-flags.webp>`__
...
.. image:: images/colour-map-transparency-rules.webp
    :width: 600

`View full size:
<images/colour-map-transparency-rules.webp>`__
