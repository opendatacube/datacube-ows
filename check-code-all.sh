...
datacube product add https://github.com/GeoscienceAustralia/dea-config/blob/master/products/baseline_satellite_data/geomedian-au/ga_ls8c_nbart_gm_cyear_3.odc-product.yaml
